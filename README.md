...
| **🧠 Real transfer learning, not a toy model** | Built on a fine-tuned ResNet50 (ImageNet → Food-101, ~100,000 images across 101 classes), not a from-scratch network that overfits in 5 epochs. The difference is measurable: **30% → 80.8%** Top-1 accuracy across the project's iterations. |
